...
//        this.handles.service.dataSource(db);
        ...
        this.router.post(/^service\/([a-z]+)(\/){0,1}([A-Za-z0-9]*)$/).bind(function (req, res, servicename, slash, id, params) {
            ...
            var result = self.handles.service.call(servicename, 'post', id, req.body);
            if (result.location) {
